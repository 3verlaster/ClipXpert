...
def main_window():
    ...
    def threading_withdraw_root():
        withdraw_root_thread = threading.Thread(target=withdraw_root)
        withdraw_root_thread.start()
    ...
    root.protocol('WM_DELETE_WINDOW', threading_withdraw_root)
